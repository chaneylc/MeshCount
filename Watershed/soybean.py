...
def quartileRange(values):
    ...
    print(map(lambda x: x[0], sortedList))
...
if __name__ == "__main__":
    ...
    ret, sure_fg = cv2.threshold(dist_transform,parameters["dtThreshScale"],255,0)
