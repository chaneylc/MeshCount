	...
	for index, image in enumerate(listdir("/home/chaneylc/Desktop/MeshCount/Test"), 1):
		...
		if sortedKeys and len(sortedKeys) >= 4:
			...
			if not result:
				...
				coinGroundTruth = cv.contourArea(lowestContour)
	 ...
	 #                            param1=500,param2=30,minRadius=200,maxRadius=200)
		...
		writeImg("detected{}.png".format(index), output)
